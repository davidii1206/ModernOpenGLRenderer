#ifndef MOSAIC_OCT_GLSL
#define MOSAIC_OCT_GLSL
...
// used for the S5 micro-buffer parametrization -- do not mix the two, they are
...
// snorm16 pair <-> uint, matching the CPU-side packing in surfel_bake.cpp.
...
// --- Hemispherical octahedral mapping (S5 micro-buffer) --------------------
//
...
// explicitly. See mosaic_resolve.comp.
