...
// ---------------------------------------------------------------------------
// Shared GPU plumbing: per-pass timing, ImGui diagnostics widgets and shader
// loading. Copied verbatim from example 40 (which took it from 39) apart from
// the namespace: nothing here is specific to a GI technique, and a shared timer
// implementation is what makes the two examples' millisecond numbers comparable.
// ---------------------------------------------------------------------------
