...
void Pipeline::set(const char* name, int v) const        { MBG_UNIFORM(prog_->uniform1i(loc, v)); }
void Pipeline::set(const char* name, unsigned v) const   { MBG_UNIFORM(prog_->uniform1ui(loc, v)); }
void Pipeline::set(const char* name, float v) const      { MBG_UNIFORM(prog_->uniform1f(loc, v)); }
void Pipeline::set(const char* name, const glm::vec2& v) const  { MBG_UNIFORM(prog_->uniform2f(loc, v.x, v.y)); }
void Pipeline::set(const char* name, const glm::vec3& v) const  { MBG_UNIFORM(prog_->uniform3f(loc, v.x, v.y, v.z)); }
void Pipeline::set(const char* name, const glm::vec4& v) const  { MBG_UNIFORM(prog_->uniform4f(loc, v.x, v.y, v.z, v.w)); }
void Pipeline::set(const char* name, const glm::ivec2& v) const { MBG_UNIFORM(prog_->uniform2iv(loc, glm::value_ptr(v))); }
void Pipeline::set(const char* name, const glm::ivec3& v) const { MBG_UNIFORM(prog_->uniform3iv(loc, glm::value_ptr(v))); }
void Pipeline::set(const char* name, const glm::mat3& v) const  { MBG_UNIFORM(prog_->uniform_matrix3fv(loc, glm::value_ptr(v))); }
void Pipeline::set(const char* name, const glm::mat4& v) const  { MBG_UNIFORM(prog_->uniform_matrix4fv(loc, glm::value_ptr(v))); }
